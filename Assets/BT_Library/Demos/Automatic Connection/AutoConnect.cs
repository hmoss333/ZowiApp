...
public class AutoConnect : MonoBehaviour
{
    ...
    public void connect ()
	{
		 ...
		 * Also Mac Address in this library is Case sensitive,  all chars must be capital letters
		 */

        //device.MacAddress = "B4:9D:0B:32:2B:A0";
        device.Name = "Zowi";
		...
		*/
		...
		//statusText.text = "Status : " + device.MacAddress.ToString();
